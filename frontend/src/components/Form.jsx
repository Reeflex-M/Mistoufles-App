    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-amber-50 to-orange-100 flex items-center justify-center p-4">
            <div className="absolute top-10 left-10 animate-bounce">
                <PawPrint size={32} className="text-amber-600 transform rotate-[-45deg]" />
            </div>
            ...
            >
                ...
                <div className="space-y-6">
                    <div className="relative">
                        ...
                        <PawPrint size={16} className="absolute right-4 top-4 text-amber-400" />
                    </div>
                ...
                >
                    <span className="flex items-center justify-center gap-2">
                        {loading ? (
                            ...
                            <>
                                <PawPrint size={20} className="transform group-hover:rotate-12 transition-transform duration-300" />
                                {name}
                            </>
                        )}
                    </span>
